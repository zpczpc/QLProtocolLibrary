namespace QLProtocolLibrary
{
    ...
    public static class QlKnownRegisters
    {
        public static readonly QlRegisterDefinition DeviceNo =
            new QlRegisterDefinition(76, "76", "DeviceNo", 4, QlPayloadType.Utf8, "设备编号");

        public static readonly QlRegisterDefinition MeasureResult =
            new QlRegisterDefinition(94, "94", "MeasureResult", 22, QlPayloadType.Raw, "测量结果复合报文");

        public static readonly QlRegisterDefinition RunStatus =
            new QlRegisterDefinition(200, "200", "RunStatus", 4, QlPayloadType.Raw, "运行状态复合报文");
        ...
        public static readonly QlRegisterDefinition WarnCode =
            new QlRegisterDefinition(204, "204", "WarnCode", 1, QlPayloadType.UInt32, "告警信息");

        public static readonly QlRegisterDefinition FaultCode =
            new QlRegisterDefinition(205, "205", "FaultCode", 1, QlPayloadType.UInt32, "故障信息");

        public static readonly QlRegisterDefinition DeviceTime =
            new QlRegisterDefinition(208, "208", "DeviceTime", 2, QlPayloadType.BcdDateTime, "设备时间");

        public static readonly QlRegisterDefinition Concentration =
            new QlRegisterDefinition(238, "238", "Concentration", 1, QlPayloadType.Single, "单浮点参数");
        ...
        public static readonly QlRegisterDefinition KbInfo =
            new QlRegisterDefinition(312, "312", "KbInfo", 7, QlPayloadType.Raw, "K/B/F 标定参数复合报文");

        public static readonly QlRegisterDefinition MeterStrongLight =
            new QlRegisterDefinition(460, "460", "AbsorbLightIntensity", 1, QlPayloadType.UInt16Array, "吸收光强");

        public static readonly QlRegisterDefinition AnalyzerCode =
            new QlRegisterDefinition(464, "464", "AnalyzerCode", 4, QlPayloadType.Utf8, "仪表编号");

        public static readonly QlRegisterDefinition VersionBundle =
            new QlRegisterDefinition(709, "709", "VersionBundle", 56, QlPayloadType.Raw, "版本信息复合报文");
